...
import com.example.fileexplorer.databinding.ItemNodeBinding
...
class TreeNodeAdapter(private var itemList: ArrayList<TreeNode>) : RecyclerView.Adapter<TreeNodeAdapter.RecyclerViewHolder?>() {
    ...
    inner class RecyclerViewHolder(private val binding: ItemNodeBinding) : RecyclerView.ViewHolder(binding.root) {
        fun updateViewHolder(treeNode: TreeNode) {
            ...
            if (treeNode.isLeaf()) {
                binding.ivExpand.setImageResource(R.drawable.ic_file)
            } else {
                if (treeNode.isExpand()) {
                    binding.ivExpand.setImageResource(R.drawable.ic_folder_expand)
                } else {
                    binding.ivExpand.setImageResource(R.drawable.ic_folder_collapse)
                }
            ...
            binding.cbName.text = treeNode.getFile().name
